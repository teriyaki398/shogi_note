...
void main() {
  test('Ke getMovablePositionSet', () {
    ...
    expect(ShogiLogicUtil.getMovablePositionSet(bsBlackDstPiece, BoardPosition(4, 4)), {BoardPosition(2, 5)});
    ...
    expect(ShogiLogicUtil.getMovablePositionSet(bsBlackOutOfBounds, BoardPosition(1, 4)), <BoardPosition>{});
    ...
    expect(ShogiLogicUtil.getMovablePositionSet(bsWhiteDstPiece, BoardPosition(4, 4)), {BoardPosition(6, 5)});
    ...
    expect(ShogiLogicUtil.getMovablePositionSet(bsWhiteOutOfBounds, BoardPosition(7, 4)), <BoardPosition>{});
