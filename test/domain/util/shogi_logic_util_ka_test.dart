...
void main() {
  test('Ka getMovablePositionSet', () {
    ...
    expect(ShogiLogicUtil.getMovablePositionSet(bsBlackDstNil, const BoardPosition(row: 4, col: 4)), {
      ...
      const BoardPosition(row: 2, col: 2),
      const BoardPosition(row: 3, col: 3),
      const BoardPosition(row: 5, col: 5),
      const BoardPosition(row: 6, col: 6),
      const BoardPosition(row: 7, col: 7),
      const BoardPosition(row: 8, col: 8),
      const BoardPosition(row: 0, col: 8),
      const BoardPosition(row: 1, col: 7),
      const BoardPosition(row: 2, col: 6),
      const BoardPosition(row: 3, col: 5),
      const BoardPosition(row: 5, col: 3),
      const BoardPosition(row: 6, col: 2),
      const BoardPosition(row: 7, col: 1),
      const BoardPosition(row: 8, col: 0),
    });
