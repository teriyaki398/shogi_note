...
void main() {
  test('Fu getMovablePositionSet', () {
    ...
    expect(ShogiLogic.getMovablePositionSet(bsBlackDstNil, BoardPosition(4, 4)), {BoardPosition(3, 4)});
    ...
    expect(ShogiLogic.getMovablePositionSet(bsBlackDstWhite, BoardPosition(4, 4)), {BoardPosition(3, 4)});
    ...
    expect(ShogiLogic.getMovablePositionSet(bsBlackDstBlack, BoardPosition(4, 4)), <BoardPosition>{});
    ...
    expect(ShogiLogic.getMovablePositionSet(bsWhiteDstNil, BoardPosition(4, 4)), {BoardPosition(5, 4)});
    ...
    expect(ShogiLogic.getMovablePositionSet(bsWhiteDstBlack, BoardPosition(4, 4)), {BoardPosition(5, 4)});
    ...
    expect(ShogiLogic.getMovablePositionSet(bsWhiteDstWhite, BoardPosition(4, 4)), <BoardPosition>{});
